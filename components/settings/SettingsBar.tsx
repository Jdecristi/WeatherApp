...
//Weather Data
import weatherData, { Units } from "../../helpers/WeatherData";
...
const SettingsBar: React.FC<Props> = (props) => {
  ...
  const [units, updateUnits] = useState<Units>(weatherData.units);
      ...
      <div className="container">
        ...
        <div className="content">
          <input
            ...
            onKeyDown={(e) =>
              e.key === "Enter" ? newSearch(location, units) : null
            }
          />
          <Dropdown
            darkMode={!weatherData.day}
            items={["FAHRENHEIT", "CELCIUS", "KELVIN"]}
            selected={unitAlias[units]}
