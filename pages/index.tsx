...
const Home: NextPage = () => {
  ...
  const newSearch = (location: string, units: string) => {
    ...
    getWeatherData(location, units).then(() => {
        ...
        localStorage.setItem('recentSearch', JSON.stringify({location: location, units: units}));
    }); 
  }
      ...
      <style jsx>
        {`
          .container {
            width: 100vw;
            height: 100vh;
            background-image: url('/images/background_images/${weatherData.day ?'day' :'night'}_background.jpeg');
